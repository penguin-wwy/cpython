static void *opcode_targets[256] = {
    ...
    &&TARGET_BINARY_OP_ADD_NUMBER,
    &&TARGET_BINARY_OP_ADD_SEQUENCE,
    &&TARGET_BINARY_OP_ADD_INPLACE_SEQUENCE,
    &&TARGET_BINARY_OP_MULTIPLY_NUMBER,
    &&TARGET_BINARY_OP_MULTIPLY_SEQUENCE,
    &&TARGET_NOP,
    &&TARGET_UNARY_POSITIVE,
    &&TARGET_UNARY_NEGATIVE,
    &&TARGET_UNARY_NOT,
    &&TARGET_BINARY_OP_MULTIPLY_INPLACE_SEQUENCE,
    &&TARGET_BINARY_OP_SUBTRACT_NUMBER,
    &&TARGET_UNARY_INVERT,
