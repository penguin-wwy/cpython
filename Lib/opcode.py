...
_specializations = {
    "BINARY_OP": [
        "BINARY_OP_ADAPTIVE",
        "BINARY_OP_ADD_NUMBER",
        "BINARY_OP_ADD_SEQUENCE",
        "BINARY_OP_ADD_INPLACE_SEQUENCE",
        "BINARY_OP_MULTIPLY_NUMBER",
        "BINARY_OP_MULTIPLY_SEQUENCE",
        "BINARY_OP_MULTIPLY_INPLACE_SEQUENCE",
        "BINARY_OP_SUBTRACT_NUMBER",
    ],
    "BINARY_SUBSCR": [
